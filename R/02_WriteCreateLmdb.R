#' @export
WriteCreateLmdb <- function(caffedir="~/Documents/caffe" , name = "MyModel" , Resize_height = NULL , Resize_width = NULL){
  ...
  new_createLmdb[9] <- paste0("TRAIN_DATA_ROOT=",caffedir,"/data/",name,"/train/")

  new_createLmdb[10] <- paste0("VAL_DATA_ROOT=",caffedir,"/data/",name,"/val/")
